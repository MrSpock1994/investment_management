...
def crypto():
    ...
    main_coins_price.place(x=30, y=20)
    bitcoin_price = ttk.Label(cripto_screen, text=get_crypto_price('BTCUSDT'))
    bitcoin_price.place(x=20, y=50)
    ada_price = ttk.Label(cripto_screen, text=get_crypto_price('ADAUSDT'))
    ada_price.place(x=20, y=70)
    solana_price = ttk.Label(cripto_screen, text=get_crypto_price('SOLUSDT'))
    solana_price.place(x=20, y=90)
    polygon_price = ttk.Label(cripto_screen, text=get_crypto_price('MATICUSDT'))
    polygon_price.place(x=20, y=110)
    polkadot_price = ttk.Label(cripto_screen, text=get_crypto_price('DOTUSDT'))
    polkadot_price.place(x=20, y=130)
    ethereum_price = ttk.Label(cripto_screen, text=get_crypto_price('ETHUSDT'))
    ethereum_price.place(x=20, y=150)
    chainlink_price = ttk.Label(cripto_screen, text=get_crypto_price('LINKUSDT'))
